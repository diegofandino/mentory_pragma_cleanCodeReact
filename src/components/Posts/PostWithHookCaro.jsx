...
import usePostCaro from '../../hooks/usePostCaro'


const PostWithHookCaro = () => {
    const {individualPost, postToShow, getNewProduct, getAllProducts} = usePostCaro()
  ...
  return (
    <div className='posts'>
        <div className='posts__add'>
            <button onClick={() => getNewProduct(1)}> Get specific product </button>
        </div>
...
export default PostWithHookCaro